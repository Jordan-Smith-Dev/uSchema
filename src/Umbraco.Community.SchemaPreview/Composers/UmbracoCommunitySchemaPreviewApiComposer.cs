...
namespace Umbraco.Community.SchemaPreview.Composers
{
    public class UmbracoCommunitySchemaPreviewApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                opt.OperationFilter<UmbracoCommunitySchemaPreviewOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunitySchemaPreviewOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.SchemaPreview.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
